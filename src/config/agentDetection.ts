...
// mention elsewhere ("I showed Void to a friend") is dictated content,
// not a command.
...
// of "void summarize this") is still a real address.
...
function locateAgentAddress(
  ...
  // STT may split the name across tokens ("void") or mishear it, so
