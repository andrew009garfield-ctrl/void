...
const DEFAULT_OPENAI_BASE = computeBaseUrl(
  [env.VOID_OPENAI_BASE_URL as string | undefined, env.OPENAI_BASE_URL as string | undefined],
  "https://api.openai.com/v1"
);

const DEFAULT_TRANSCRIPTION_BASE = computeBaseUrl(
  [
    env.VOID_TRANSCRIPTION_BASE_URL as string | undefined,
...
// Void Cloud API
export const VOID_API_URL = (env.VITE_VOID_API_URL as string) || "";
