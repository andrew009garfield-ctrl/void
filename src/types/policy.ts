...
/**
 * Organization policy delivered by the Void API and enforced by the app.
 *
 * Mirrors the canonical schema in `void-api/lib/policy-schema.ts` and
 * `void-admin/lib/policy-schema.ts` — keep the three in sync. Mode ids are
