...
const DBUS_SERVICE_NAME = "com.void.App";
const DBUS_OBJECT_PATH = "/com/void/App";
const DBUS_INTERFACE = "com.void.App";

// Per-slot gsettings paths and display names
const SLOT_CONFIG = {
  dictation: {
    path: "/org/gnome/settings-daemon/plugins/media-keys/custom-keybindings/void/",
    name: "Void Toggle",
  },
  meeting: {
    path: "/org/gnome/settings-daemon/plugins/media-keys/custom-keybindings/void-meeting/",
    name: "Void Meeting",
  },
  voiceAgent: {
    path: "/org/gnome/settings-daemon/plugins/media-keys/custom-keybindings/void-voice-agent/",
    name: "Void Voice Assistant",
  },
  translation: {
    path: "/org/gnome/settings-daemon/plugins/media-keys/custom-keybindings/void-translation/",
    name: "Void Translation",
  },
};
...
class GnomeShortcutManager {
  ...
  removeRetiredAgentKeybinding() {
    const retiredPath =
      "/org/gnome/settings-daemon/plugins/media-keys/custom-keybindings/void-agent/";
    try {
