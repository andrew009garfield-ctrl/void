...
// VOID_YTDLP_CACHE_DIR overrides the location (relocate it, or isolate it in tests).
const YT_DLP_CACHE_DIR =
  process.env.VOID_YTDLP_CACHE_DIR ||
  path.join(os.homedir(), ".cache", "void", "yt-dlp");
