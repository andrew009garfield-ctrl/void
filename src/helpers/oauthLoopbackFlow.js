...
const DEFAULT_DESKTOP_CALLBACK_URL = "https://void-auth-app-2.firebaseapp.com/__/auth/handler";
...
function getDesktopCallbackUrl() {
  return process.env.VITE_VOID_OAUTH_CALLBACK_URL || DEFAULT_DESKTOP_CALLBACK_URL;
}

function getProtocol() {
  const channel = process.env.VOID_CHANNEL || "production";
