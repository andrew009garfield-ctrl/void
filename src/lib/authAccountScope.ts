const ACCOUNT_SCOPE_USER_KEY = "void:accountScopeUserId";
const ACCOUNT_SCOPE_VALIDATED_KEY = "void:accountScopeValidated";
const ACCOUNT_SCOPE_PURGE_REQUIRED_KEY = "void:accountScopePurgeRequired";
