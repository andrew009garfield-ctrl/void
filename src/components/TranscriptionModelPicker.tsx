...
> = {
  ...
  corti: {
    consoleUrl: "https://www.corti.ai/?utm_source=referral&utm_content=&utm_campaign=void",
    fields: [
  ...
  tinfoil: {
    consoleUrl: "https://tinfoil.sh/inference?utm_source=referral&utm_campaign=void",
...
export default function TranscriptionModelPicker({
  ...
  useEffect(() => {
    ...
    window.addEventListener("void-models-cleared", handleModelsCleared);
    return () => window.removeEventListener("void-models-cleared", handleModelsCleared);
