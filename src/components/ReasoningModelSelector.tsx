                ...
                <>
                  ...
                  {displayedCloudProvider === "tinfoil" && (
                    <div className="space-y-2">
                      <div className="flex items-baseline justify-between">
                        <h4 className="font-medium text-foreground">{t("common.apiKey")}</h4>
                        <GetApiKeyLink url="https://tinfoil.sh/inference?utm_source=referral&utm_campaign=void" />
                      </div>
                      <ApiKeyInput
                  ...
                  {displayedCloudProvider === "corti" && (
                    <div className="space-y-2">
                      ...
                      <div className="flex items-baseline justify-between">
                        <h4 className="font-medium text-foreground">{t("common.apiKey")}</h4>
                        <GetApiKeyLink url="https://www.corti.ai/?utm_source=referral&utm_campaign=void" />
                      </div>
                      <ApiKeyInput
                        apiKey={cortiApiKey}
