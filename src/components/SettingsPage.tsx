...
function TranscriptionSection({
  ...
  const {
    ...
    [
      {
        id: "void",
        label: t("settingsPage.transcription.modes.void"),
        description: t("settingsPage.transcription.modes.voidDesc"),
  ...
  const handleTranscriptionModeSelect = (mode: InferenceMode) => {
    ...
    setCloudTranscriptionMode(mode === "void" ? "void" : "byok");
      ...
      onConfirm: async () => {
        ...
        try {
          ...
          if (anyFailed) {
            ...
            window.dispatchEvent(new Event("void-models-cleared"));
            showAlertDialog({
                      ...
                      steps: [
                        ...
                        },
                        {
                          ...
                          desc: t("settingsPage.general.waylandPaste.guide.group.step2Desc", {
                            defaultValue:
                              "Group changes only take effect after a new login session. Log out of your desktop and log back in, then reopen Void.",
                          }),
                        },
                      ],
                    },
