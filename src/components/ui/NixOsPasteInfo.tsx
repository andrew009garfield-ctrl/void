...
inputs.void.url = "github:Void/void";

# in your NixOS modules
imports = [ void.nixosModules.default ];
programs.void = {
  enable = true;
  users = [ "<you>" ];
};`;
      ...
      <div className="space-y-2">
        ...
        <p className="text-xs text-muted-foreground">
          {t("settingsPage.general.waylandPaste.nixos.flakeDesc", {
            defaultValue:
              "If you install Void from the flake, programs.void.enable turns on ydotool, the uinput module and the group memberships for you.",
          })}
        </p>
