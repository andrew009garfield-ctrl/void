...
Outbound hosts the Void desktop app contacts. For firewall, proxy, and
...
Contacted by every install using Void Cloud (the default after
onboarding).
...
Void Cloud routes streaming sessions through one of four providers.
