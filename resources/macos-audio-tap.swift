...
final class AudioTapCapture {
    ...
    private let ioQueue = DispatchQueue(label: "com.void.audio-tap")
    private let listenerQueue = DispatchQueue(label: "com.void.audio-tap.listeners")
    ...
    func start() throws {
        ...
        tapDescription.name = "void-audio-tap"
    ...
    private func createAggregateDevice(tapUID: String) throws {
        let description: [String: Any] = [
            kAudioAggregateDeviceNameKey: "Void Audio Tap",
            kAudioAggregateDeviceUIDKey: "com.void.audio-tap.\(UUID().uuidString)",
...
let emitQueue = DispatchQueue(label: "com.void.audio-tap.emit")
...
func makeError(
    ...
    return NSError(domain: "VoidAudioTap", code: Int(status ?? -1), userInfo: userInfo)
}
