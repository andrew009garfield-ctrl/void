<p align="center">
  <img src="src/assets/logo.svg" alt="Void" width="120" />
</p>

<h1 align="center">Void</h1>

<p align="center">
  <a href="https://github.com/Void/void/blob/main/LICENSE"><img src="https://img.shields.io/github/license/Void/void?style=flat" alt="License" /></a>
  <img src="https://img.shields.io/badge/platform-macOS%20%7C%20Windows%20%7C%20Linux-lightgrey?style=flat" alt="Platform" />
  <a href="https://github.com/Void/void/releases/latest"><img src="https://img.shields.io/github/v/release/Void/void?style=flat&sort=semver" alt="GitHub release" /></a>
  <a href="https://github.com/Void/void/releases"><img src="https://img.shields.io/github/downloads/Void/void/total?style=flat&color=blue" alt="Downloads" /></a>
  <a href="https://github.com/Void/void/stargazers"><img src="https://img.shields.io/github/stars/Void/void?style=flat" alt="GitHub stars" /></a>
</p>
...
Void turns your voice into text, notes, and actions from your desktop. Press a hotkey, speak, and your words appear at your cursor. Choose between fully private offline transcription with local speech-to-text models like Orukeet, Whisper, NVIDIA Parakeet, and Cohere Transcribe — where your audio never leaves your device — or cloud processing for speed. No data collection, no telemetry, fully open source.

## Download

| Platform              | Download                                                                                                                                                                                                                                                                                  |
| --------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| macOS (Apple Silicon) | [`.dmg`](https://github.com/Void/void/releases/latest)                                                                                                                                                                                                                        |
| macOS (Intel) \*      | [`.dmg`](https://github.com/Void/void/releases/latest)                                                                                                                                                                                                                        |
| Windows               | [`.exe`](https://github.com/Void/void/releases/latest)                                                                                                                                                                                                                        |
| Linux                 | [`.AppImage`](https://github.com/Void/void/releases/latest) / [`.deb`](https://github.com/Void/void/releases/latest) / [`.rpm`](https://github.com/Void/void/releases/latest) / [`.tar.gz`](https://github.com/Void/void/releases/latest) |
...
```bash
git clone https://github.com/Void/void.git
cd void
npm install
npm run dev
```
...
[![Star History Chart](https://api.star-history.com/svg?repos=Void/void&type=date&legend=top-left)](https://www.star-history.com/#Void/void&type=date&legend=top-left)

## Sponsors

<p align="center">
  <a href="https://console.neon.tech/app/?promo=void">
    <picture>
...
<p align="center"><a href="https://console.neon.tech/app/?promo=void">Neon</a> is the serverless Postgres platform powering Void Cloud.</p>
...
- **[Neon](https://console.neon.tech/app/?promo=void)** — serverless Postgres powering Void Cloud
