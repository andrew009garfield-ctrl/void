...
test("a packaged dictation window ignores control in its install path", async (t) => {
  ...
  globalThis.window = {
    location: {
      pathname:
        "/Users/controller/Applications/Void.app/Contents/Resources/app.asar/src/dist/index.html",
      search: "",
    },
  };
...
test("only the explicit panel=true query selects the control panel", async (t) => {
  ...
  globalThis.window = {
    location: {
      pathname: "/Applications/Void.app/Contents/Resources/app.asar/src/dist/index.html",
      search: "?panel=true",
    },
  };
