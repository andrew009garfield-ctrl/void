...
test("buildMeetingContext names the owner and invited participants", async () => {
  ...
  const identity = {
    ...
    selfEmail: "gabe@void.com",
    participants: [
      attendee("gabe@void.com", "Gabriel Stein", true),
  ...
  assert.equal(
    ...
    [
      "## Meeting Context",
      'The user taking these notes ("Gabriel Stein" in the transcript) is Gabriel Stein <gabe@void.com>.',
...
test("collectKnownPeople merges owner, participants, mappings, and named segments", async () => {
  ...
  assert.deepEqual(people, [
    { name: "Gabriel Stein", email: "gabe@void.com" },
